...
import { ROUTES, buildCareerIntelligencePath } from "../../constants/routes.js";
...
const AnalysisPage = () => {
  ...
  const handleCareerIntelligenceRedirect = () => {
  if (!selectedRole) {
    toast.error("Please select a target job role first.");
    return;
  }

  navigate(buildCareerIntelligencePath(id, selectedRole));
};
              ...
              >
                ...
                {!isFetchingRoles && !rolesError && jobRoles.length > 0 && (
                  <RoleSelector
                    ...
                    onMatch={handleCareerIntelligenceRedirect}
                    onReset={resetMatch}
